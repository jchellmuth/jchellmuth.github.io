...
Each have great documentation and I suggest you read through their tutorials to get you started with flow analysis in R. The following tutorial assumes that you have basic knowledge of flo cytometry data analysis (such as basic gating operations) and familiarized yourself with the basics of flowCore datastructures and functions.
