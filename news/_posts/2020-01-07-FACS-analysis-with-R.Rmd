...
-->
**Note:** Updated March 28, 2022 to reflect updated packages. Previous tutorial version (v1) is [here.]({% md/2020-01-07-FACS-analysis-with-R-v1.md %})
...
pData(fs)[1:3,]
```
The default channel names on most FACS machines are useless and changing them there is often tedious. On our BD FACS Canto II, for example, the [405|450/50] channel is named "Pacific.Blue.A" and the [488|530/30] is named "FITC.A" - irrespective of the fluorphore you are actually reading.
...
```{r, 2020-01-07-singlets-gate, message=F, warning=F, fig.width=3, fig.height=3}
...
```{r, 2020-01-07-singlets-gate-check, message=F, warning=F, fig.width=3, fig.height=3}
...
```{r, 2020-01-07-live-gate, message=F, warning=F,fig.width=3, fig.height=3}
...
```{r, 2020-01-07-live-gate-facet, message=F, warning=F, fig.width=14, fig.height=8}
...
```{r, 2020-01-07-gfp-gate, message=F, warning=F,fig.width=3, fig.height=3}
...
```{r, 2020-01-07-gfp-gate-facet, message=F, warning=F, fig.width=14, fig.height=8}
...
<br> I hope this tutorial was useful to you. Please feel free to email
...
```{r, fig.width=14, fig.height=8, include=F, eval=F}
